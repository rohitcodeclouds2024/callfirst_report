...
import RevenueGraph from "@/components/ui/reports/graphs/RevenueGraph";
import RevenueDataReport from "@/components/ui/reports/RevenueDataReport";
  ...
  return (
    <div className="dashboard-content">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-x-4 mb-6">
        <h3 className="text-2xl font-semibold mb-4 lg:mb-0">Revenue</h3>
        <div className="grow flex flex-col sm:flex-row gap-2 items-center justify-end">
          <div className="w-full lg:w-1/5 xl:w-1/6">
            <select
              className="w-full bg-white dark:bg-surface px-4 py-3 text-sm leading-none border border-border rounded-md focus:outline-none focus:border-primary"
